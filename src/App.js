...
function App() {
  return (
    <>
        ...
        <section class="text-white body-font bg-gradient-to-r from-pink-700 via-pink-500 to-orange-400">
          <div class="container mx-auto flex  md:flex-row flex-col items-center pt-20 ">
            <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              <h1 class="title-font sm:text-5xl text-5xl mb-4 font-medium text-white">Marketing de Contenido
                <br class="hidden lg:inline-block" />
              </h1>
              <p class="mb-8 leading-relaxed mt-12">Consigue aumentar tus clientes de una manera <br></br>efectiva, sin elevados costos de inversión.</p>
              <div class="flex justify-center">
                <button class="inline-flex text-white bg-transparent border-solid border py-2 px-8 focus:outline-none hover:bg-white hover:text-pink-500 rounded-full  text-lg">Planes</button>
                <button class="ml-4 inline-flex text-gray-700 bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-300 rounded-full text-lg">Cotizar</button>
              </div>
            </div>
            <div class="	">
              <img class="  " alt="hero" src="https://i.ibb.co/H4vSb2L/fondo.png" />
            </div>
          </div>
        </section>
        <section class="text-gray-700 body-font border-t border-gray-200">
          <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
              <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">NUESTRO COMPROMISO CONTIGO</h2>
              <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900">Solo EsahMark te ofrece: </h1>
            </div>
            <div class="flex flex-wrap -m-4">
              <div class="p-4 md:w-1/3">
                <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                  <div class="flex items-center mb-3">
                    <div class="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full  bg-gradient-to-r from-pink-700 via-pink-500 to-orange-400 text-white flex-shrink-0">
                      <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                        <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>
                      </svg>
                    </div>
                    <h2 class="text-gray-900 text-lg title-font font-medium">Compromiso</h2>
                  </div>
                  <div class="flex-grow">
                    <p class="leading-relaxed text-base">
                      Nuestros servicios ofrecen el trato especial encargado por cada mienbro de nuestro equipo.
                    </p>
                    <a class="mt-3 text-pink-700 inline-flex items-center">Ver más
              ...
              <div class="p-4 md:w-1/3">
                <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                  <div class="flex items-center mb-3">
                    ...
                    <h2 class="text-gray-900 text-lg title-font font-medium">Trabajo Profesional </h2>
                  </div>
                  <div class="flex-grow">
                    <p class="leading-relaxed text-base">Nuestros servicios ofrecen el trato especial encargado por cada mienbro de nuestro equipo.</p>
                    <a class="mt-3 text-pink-700 inline-flex items-center">Ver más
                      <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                      </svg>
              ...
              <div class="p-4 md:w-1/3">
                <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                  <div class="flex items-center mb-3">
                    ...
                    <h2 class="text-gray-900 text-lg title-font font-medium">Adaptable </h2>
                  </div>
                  <div class="flex-grow">
                    <p class="leading-relaxed text-base">Nuestros servicios ofrecen el trato especial encargado por cada mienbro de nuestro equipo..</p>
                    <a class="mt-3 text-pink-700 inline-flex items-center">Ver más
