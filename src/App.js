            ...
            <div className="flex flex-wrap -m-4">
              <div className="xl:w-1/3 md:w-1/2 p-4">
                <div className="border border-gray-300 p-6 rounded-lg">
                  ...
                  <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Reportes</h2>
                  <p className="leading-relaxed text-base">Utilizamos herramientas especificas y concretas para dar resultados esperados.</p>
                </div>
              </div>
              <div className="xl:w-1/3 md:w-1/2 p-4">
                <div className="border border-gray-300 p-6 rounded-lg">
                  ...
                  <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Automatización</h2>
